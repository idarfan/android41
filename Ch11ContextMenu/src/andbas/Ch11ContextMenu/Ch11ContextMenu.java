package andbas.Ch11ContextMenu;
...
public class Ch11ContextMenu extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		LinearLayout linearLay = 
				(LinearLayout)findViewById(R.id.IdlinearLay);
	...
	private void ShowDial() {      
		AlertDialog.Builder adBuild=
				new AlertDialog.Builder(Ch11ContextMenu.this){};
		adBuild.setTitle("關於本程式");
		adBuild.setMessage("本程式示範  快顯功能表  之設計 !");
