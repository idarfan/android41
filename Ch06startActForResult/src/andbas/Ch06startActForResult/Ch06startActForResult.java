package andbas.Ch06startActForResult;
...
public class Ch06startActForResult extends Activity {
    ...
    private OnClickListener btListener = new OnClickListener() {    
    	public void onClick(View v) {      
    		...
    		intent.setClass(Ch06startActForResult.this, LogSuccAct.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent  data) {
    	...
    	case RESULT_OK:
    		 ...
    		 Toast.makeText(Ch06startActForResult.this,
    				sayHello,
    				Toast.LENGTH_SHORT)
    		      .show();			
