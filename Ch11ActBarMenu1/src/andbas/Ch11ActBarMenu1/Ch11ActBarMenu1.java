package andbas.Ch11ActBarMenu1;
...
public class Ch11ActBarMenu1 extends Activity {
	...
	private void ShowDial() {      
		AlertDialog.Builder adBuild=
				new AlertDialog.Builder(Ch11ActBarMenu1.this){};
		adBuild.setTitle("關於本程式");
		adBuild.setMessage("本程式示範  動作列功能表  之設計 !");
